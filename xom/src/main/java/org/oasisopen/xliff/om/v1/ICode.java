 ...
 * that both objects have the values of these fields always the same. That is, the following code is true:
 * <pre>
ICode sc = content.appendOpeningCode("1", "&lt;b>");
sc.setType("fmt");
ICode ec = content.closeCode("1", "&lt;b>");
